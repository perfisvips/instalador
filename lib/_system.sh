...
system_git_clone() {
  ...
  sudo su - deploy <<EOF
  git clone ${link_git} /www/wwwroot/hrd.com.br/deploy/${instancia_add}/
EOF
...
sudo su - deploy <<EOF
 rm -rf /www/wwwroot/hrd.com.br/deploy/${empresa_delete}
...
sleep 2
  ...
  sudo su - deploy <<EOF
  cd && cd /www/wwwroot/hrd.com.br/deploy/${empresa_dominio}/frontend
  sed -i "1c\REACT_APP_BACKEND_URL=https://${alter_backend_url}" .env
  cd && cd /www/wwwroot/hrd.com.br/deploy/${empresa_dominio}/backend
